...
kategori
ASC';
$qry_kat = $con->query($sql_kat) or die ($con->error);
...
berita
WHERE
berita.id_berita='$_GET[id_berita]'";
...
if (isset($_POST['btn_edit'])) {
    ...
    if (count($message)==0) {
    	$insert_sql = "UPDATE berita SET judul = '$judul', id_kategori ='$kategori', gambar = '$file_name_gambar', teks_berita = '$teks_berita' WHERE id_berita = '$_GET[id_berita]'";
    	$insert_qry = $con->query($insert_sql) or die ($con->error);
