								...
								<?php while ($news_list = $qry->fetch_assoc()) { ?>
									<tr>
										...
										<td align="center" style="margin:2px;">
											...
											<a class="btn btn-sm btn-primary" target="_blank" href="<?php echo $base_url.'Berita/berita.php?id_berita='.$news_list['id_berita']; ?>">
												<i class="fa fa-eye"></i>
											</a>
											<a href="edit-berita.php?id_berita=<?=$news_list['id_berita']?>" class="btn btn-sm btn-success">
												<i class="fa fa-edit"></i>
											</a>
											<a onclick="return confirm('Anda Yakin Ingin Menghapus Data Ini?');" href="hapus-berita.php?id_berita=<?=$news_list['id_berita']?>" class="btn btn-sm btn-danger">
