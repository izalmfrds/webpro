...
$qry_pesan = $con->query($sql_pesan);

$pesan = $qry_pesan->fetch_assoc();

$update = "UPDATE pesan SET status = 'dibaca' WHERE pesan_id = '$_GET[pesan_id]'";

$qry = $con->query($update) or die($con->error);
?>
				...
				<div class="panel-body">
                    ...
                    <div class="row">
                        <div class="col-md-12">
                            ...
                            <a href="hapus-pesan.php?pesan_id=<?=$pesan['pesan_id']?>" class="btn btn-danger btn-sm"><i class="fa fa-trash"></i> Hapus Pesan</a>
                        </div>
                    </div>
				</div>
			</div>
