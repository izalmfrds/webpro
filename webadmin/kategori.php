...
$qry = $con->query($sql) or die ($con->error);
								...
								<?php while ($kat_list = $qry->fetch_assoc()) { ?>
									<tr>
										...
										<td align="center">
											...
											<a onclick="return confirm('Anda Yakin Ingin Menghapus Data Ini?');" href="aksi-kat.php?act=hapus&amp;id_kategori=<?=$kat_list['id_kategori']?>" class="btn btn-sm btn-danger">
												<i class="fa fa-trash"></i>
											</a>
											<a href="edit_kat.php?id_kategori=<?= $kat_list['id_kategori']; ?>" class="btn btn-sm btn-primary">
