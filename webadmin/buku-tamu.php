...
LIMIT ".$offset.",". $limit;
$qry = $con->query($sql) or die ("Error retrieving data: ".$con->error);

$sql_rec = "SELECT buku_tamu.komentar_id FROM buku_tamu";

$total_rec = $con->query($sql_rec) or die ("Error retrieving number:".$con->error);
							...
							<table class="table table-hover">
								...
								<?php } else { ?>
									...
									<tr>
										...
										<td align="center">
											<a data-toggle="tooltip" data-placement="bottom" title="Ubah Status" href="ubah-komentar.php?komentar_id=<?php echo $pesan['komentar_id']?>" class="btn btn-xs btn-success">
												<i class="fa fa-edit"></i>
											</a>
											<a onclick="return confirm('Anda Yakin Ingin Menghapus Data Ini?');" data-toggle="tooltip" data-placement="bottom" title="Hapus" href="hapus-komentar.php?komentar_id=<?php echo $pesan['komentar_id']?>" class="btn btn-danger btn-xs">
