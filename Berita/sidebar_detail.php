					...
					<div class="col-md-4 sidebar">
						...
						<div class="sidebar-item">
							...
							<?php while ($populer_list = $list_populer->fetch_array()) { ?>
								<li>
									<a href="<?php echo $base_url."berita.php?id_berita=".$populer_list['id_berita']."&amp;judul=".strtolower(str_replace(" ", "-", $populer_list['judul'])); ?>">
										<img src="<?php echo $base_url."../images/".$populer_list['gambar']; ?>" class="img-responsive wow fadeIn">
									</a>
									<p>Oleh: <a href="<?php echo $base_url."author.php?id_berita=".$populer_list['id_admin']; ?>"><?php echo $populer_list['nama_lengkap']; ?></a>&nbsp;&nbsp;&ndash;&nbsp;&nbsp;<?php echo $populer_list['tgl_posting']; ?></p>
									<a href="<?php echo $base_url."berita.php?id_berita=".$populer_list['id_berita']."&amp;judul=".strtolower(str_replace(" ", "-", $populer_list['judul'])); ?>">
						...
						<div class="sidebar-item">
							...
							<?php while ($terkini_list = $list_terkini->fetch_array()) { ?>
								<li>
									<a href="<?php echo $base_url."berita.php?id_berita=".$terkini_list['id_berita']."&amp;judul=".strtolower(str_replace(" ", "-", $terkini_list['judul'])); ?>">
